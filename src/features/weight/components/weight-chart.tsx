...
export function WeightChart({ entries }: { entries: WeightLog[] }) {
  ...
  return <section className="weight-chart-panel" aria-labelledby="chart-title">
    ...
    {entries.length ? <>
      ...
      <p id="chart-help" className="chart-help">Daily measurements · Gaps are unrecorded days. Tap a point or use arrow keys on the chart. Exact values are in the history below.</p>
